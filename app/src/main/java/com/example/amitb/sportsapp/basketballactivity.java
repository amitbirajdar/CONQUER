...
public class basketballactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basketballactivity);
        arrayList.add(new sportlayout("ICT", "RJ COLLEGE", "131", "108", "WINNER: ICT COLLEGE", "CNMS GROUND"));
        arrayList.add(new sportlayout("VJTI", "SIES", "112", "104", "WINNER: VJTI COLLEGE", "CNMS GROUND"));
        arrayList.add(new sportlayout("RIZVI COLLEGE", "SINHAGAD", "85", "92", "WINNER: SINHAGAD COLLEGE", "CNMS GROUND"));
        arrayList.add(new sportlayout("KHALSA", "RAIT", "74", "82", "WINNER: RAIT COLLEGE", "CNMS GROUND"));
        arrayList.add(new sportlayout("MPSTME B", "KJ COLLEGE", "66", "94", "WINNER: KJ COLLEGE", "CNMS GROUND"));
        ...
        gallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(basketballactivity.this, basketballgallery.class));
            }
        });
        stats.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(basketballactivity.this, Basketballstats.class));
            }
        });
        team.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(basketballactivity.this,team.class));
            }
        });
        initRecyclerView();
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                uri = Uri.parse("https://docs.google.com/forms/d/e/1FAIpQLSfwPVUryYvWJ1KGZDPnzf_r8w6BBAtHLKQNpGGuOtC4t9On3w/viewform?c=0&w=1");
